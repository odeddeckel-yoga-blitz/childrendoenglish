...
const WORDS = {
  ...
  duck: ['duck mallard swimming water', 'Anas platyrhynchos duck', 'domestic duck white'],
  pig: ['pig piglet farm pink', 'Schwein pig domestic', 'pig farm animal snout'],
  hen: ['hen chicken farm', 'Huhn hen domestic', 'chicken hen brown'],
  ant: ['ant insect close macro', 'Ameise ant', 'red ant insect'],
  bee: ['honeybee flower pollinating', 'Biene bee', 'bee insect macro'],
  mouse: ['mouse small rodent', 'Maus mouse', 'house mouse Mus musculus'],
  snake: ['green snake coiled', 'Schlange snake', 'corn snake pet reptile'],
  tiger: ['tiger portrait face', 'Panthera tigris tiger', 'Bengal tiger stripes'],
  zebra: ['zebra stripes standing', 'Zebra Equus', 'zebra savanna Africa'],
  deer: ['deer standing forest', 'Hirsch deer', 'white tailed deer'],
  goat: ['goat farm animal horns', 'Ziege goat', 'domestic goat standing'],
  shark: ['great white shark underwater', 'Hai shark', 'shark fish ocean'],
  crocodile: ['crocodile reptile water', 'Krokodil crocodile', 'Crocodylus crocodile'],
  kangaroo: ['kangaroo standing Australia', 'Känguru kangaroo', 'red kangaroo Macropus'],
  hippo: ['hippopotamus water mouth', 'Nilpferd hippo', 'Hippopotamus amphibius'],
  butterfly: ['butterfly colorful wings flower', 'Schmetterling butterfly', 'monarch butterfly orange'],
  camel: ['camel desert standing', 'Kamel camel', 'dromedary camel hump'],
  panda: ['giant panda bamboo eating', 'Pandabär panda', 'Ailuropoda melanoleuca panda'],
  ...
  orange: ['Apfelsine orange fruit half slice', 'mandarin orange peeled fruit', 'tangerine orange fruit'],
  cake: ['chocolate birthday cake photo', 'Schokoladenkuchen chocolate cake', 'layer cake frosting dessert'],
  soup: ['bowl soup warm vegetable', 'Suppe soup bowl', 'chicken soup bowl'],
  juice: ['glass orange juice fresh', 'Saft juice glass', 'orange juice glass'],
  potato: ['potato single brown', 'Kartoffel potato', 'potato vegetable raw'],
  salad: ['fresh green salad bowl', 'Salat salad vegetables', 'mixed salad bowl'],
  spaghetti: ['spaghetti pasta plate', 'Spaghetti Nudeln', 'spaghetti bolognese'],
  cucumber: ['cucumber green vegetable', 'Gurke cucumber', 'cucumber sliced fresh'],
  icecream: ['ice cream cone scoop', 'Eis Eiscreme ice cream', 'ice cream sundae'],
  popcorn: ['popcorn bucket movie', 'Popcorn snack', 'popcorn bowl yellow'],
  lemon: ['lemon yellow citrus fruit', 'Zitrone lemon', 'lemon single fresh'],
  cherry: ['Kirschen cherries red ripe bowl', 'cherry fruit red pair stem', 'two cherries red fruit'],
  pepper: ['bell pepper red vegetable', 'Paprika pepper', 'red bell pepper'],
  noodles: ['noodles bowl chopsticks', 'Nudeln noodles', 'ramen noodles bowl'],
