...
const SEARCH_OVERRIDES = {
  // Letter-path expansion 2026-09
  wolf: 'gray wolf animal',
  insect: 'ladybug insect closeup',
  zoo: 'zoo entrance animals',
  jam: 'strawberry jam jar',
  nut: 'walnuts nuts',
  donut: 'glazed donut sprinkles',
  ice: 'ice cubes',
  leaf: 'green leaf single',
  jungle: 'jungle rainforest',
  acorn: 'acorn oak nut',
  kettle: 'tea kettle stove',
  vase: 'flower vase',
  lock: 'padlock metal',
  quilt: 'patchwork quilt colorful',
  hammer: 'hammer tool',
  jet: 'jet airplane flying',
  yacht: 'white yacht sailing',
  anchor: 'ship anchor',
  wheel: 'bicycle wheel',
  desk: 'school desk classroom',
  violin: 'violin instrument',
  xylophone: 'xylophone instrument colorful',
  newspaper: 'folded newspaper',
  king: 'king crown royal portrait',
  queen: 'queen crown royal portrait',
  nurse: 'nurse hospital uniform',
  astronaut: 'astronaut spacesuit',
  'x-ray': 'x-ray hand radiograph',
  heart: 'red heart shape',
  uniform: 'school uniform children',
  glove: 'winter gloves pair',
  ring: 'gold ring jewelry',
  unicorn: 'unicorn illustration white',
  dragon: 'dragon illustration',
  arrow: 'archery bow arrow target',
