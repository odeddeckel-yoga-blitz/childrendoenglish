...
export const WORDS = [
  ...
  // === LETTER-PATH EXPANSION 2026-09 (thin letters Q/X/U/I/J/Y/Z/K/O + high-imageability) ===
  // Animals
  { id: 'alligator', word: 'alligator', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A large reptile with a long tail and strong jaws', exampleSentence: 'The alligator rested by the swamp.', phonetic: '/ˈælɪɡeɪtər/', hebrewTranslation: 'אליגטור', imageUrl: '/images/alligator.webp' },
  { id: 'koala', word: 'koala', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A furry gray animal from Australia that climbs trees', exampleSentence: 'The koala slept in the eucalyptus tree.', phonetic: '/koʊˈɑːlə/', hebrewTranslation: 'קואלה', imageUrl: '/images/koala.webp' },
  { id: 'ostrich', word: 'ostrich', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A very tall bird with long legs that cannot fly', exampleSentence: 'An ostrich can run very fast.', phonetic: '/ˈɒstrɪtʃ/', hebrewTranslation: 'יען', imageUrl: '/images/ostrich.webp' },
  { id: 'wolf', word: 'wolf', level: 'beginner', partOfSpeech: 'noun', category: 'animals', definition: 'A wild animal that looks like a big dog and howls', exampleSentence: 'The wolf howled at the moon.', phonetic: '/wʊlf/', hebrewTranslation: 'זאב', imageUrl: '/images/wolf.webp' },
  { id: 'jellyfish', word: 'jellyfish', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A soft sea animal with a body like jelly', exampleSentence: 'A jellyfish floated in the clear water.', phonetic: '/ˈdʒɛlifɪʃ/', hebrewTranslation: 'מדוזה', imageUrl: '/images/jellyfish.webp' },
  { id: 'insect', word: 'insect', level: 'beginner', partOfSpeech: 'noun', category: 'animals', definition: 'A small animal with six legs, like an ant or a bee', exampleSentence: 'A tiny insect landed on the flower.', phonetic: '/ˈɪnsɛkt/', hebrewTranslation: 'חרק', imageUrl: '/images/insect.webp' },
  { id: 'zoo', word: 'zoo', level: 'beginner', partOfSpeech: 'noun', category: 'animals', definition: 'A place where people can see many kinds of animals', exampleSentence: 'We saw lions and monkeys at the zoo.', phonetic: '/zuː/', hebrewTranslation: 'גן חיות', imageUrl: '/images/zoo.webp' },
  // Food
  { id: 'jam', word: 'jam', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A sweet spread made from cooked fruit', exampleSentence: 'She put strawberry jam on her bread.', phonetic: '/dʒæm/', hebrewTranslation: 'ריבה', imageUrl: '/images/jam.webp' },
  { id: 'yogurt', word: 'yogurt', level: 'intermediate', partOfSpeech: 'noun', category: 'food', definition: 'A thick creamy food made from milk', exampleSentence: 'He ate yogurt with fruit for breakfast.', phonetic: '/ˈjoʊɡərt/', hebrewTranslation: 'יוגורט', imageUrl: '/images/yogurt.webp' },
  { id: 'onion', word: 'onion', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A round vegetable with many layers that can make you cry', exampleSentence: 'Mom chopped an onion for the soup.', phonetic: '/ˈʌnjən/', hebrewTranslation: 'בצל', imageUrl: '/images/onion.webp' },
  { id: 'grapes', word: 'grapes', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'Small round sweet fruits that grow in bunches', exampleSentence: 'She shared her grapes with a friend.', phonetic: '/ɡreɪps/', hebrewTranslation: 'ענבים', imageUrl: '/images/grapes.webp' },
  { id: 'nut', word: 'nut', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A dry fruit with a hard shell that you can eat', exampleSentence: 'The squirrel hid a nut under the tree.', phonetic: '/nʌt/', hebrewTranslation: 'אגוז', imageUrl: '/images/nut.webp' },
  { id: 'donut', word: 'donut', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A sweet fried cake shaped like a ring', exampleSentence: 'He picked a donut with pink icing.', phonetic: '/ˈdoʊnʌt/', hebrewTranslation: 'סופגנייה', imageUrl: '/images/donut.webp' },
  // Nature
  { id: 'ice', word: 'ice', level: 'beginner', partOfSpeech: 'noun', category: 'nature', definition: 'Frozen water that is cold and hard', exampleSentence: 'The lake was covered with ice in winter.', phonetic: '/aɪs/', hebrewTranslation: 'קרח', imageUrl: '/images/ice.webp' },
  { id: 'leaf', word: 'leaf', level: 'beginner', partOfSpeech: 'noun', category: 'nature', definition: 'A flat green part that grows on a tree or plant', exampleSentence: 'A red leaf fell from the tree.', phonetic: '/liːf/', hebrewTranslation: 'עלה', imageUrl: '/images/leaf.webp' },
  { id: 'jungle', word: 'jungle', level: 'intermediate', partOfSpeech: 'noun', category: 'nature', definition: 'A thick forest in a hot place with many plants and animals', exampleSentence: 'Monkeys swing through the jungle.', phonetic: '/ˈdʒʌŋɡəl/', hebrewTranslation: "ג'ונגל", imageUrl: '/images/jungle.webp' },
  { id: 'acorn', word: 'acorn', level: 'intermediate', partOfSpeech: 'noun', category: 'nature', definition: 'The small nut of an oak tree', exampleSentence: 'The squirrel collected an acorn.', phonetic: '/ˈeɪkɔːrn/', hebrewTranslation: 'בלוט', imageUrl: '/images/acorn.webp' },
  // Home
  { id: 'igloo', word: 'igloo', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A round house built from blocks of snow', exampleSentence: 'They built an igloo from snow blocks.', phonetic: '/ˈɪɡluː/', hebrewTranslation: 'איגלו', imageUrl: '/images/igloo.webp' },
  { id: 'kettle', word: 'kettle', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A pot used to boil water for tea', exampleSentence: 'The kettle whistled when the water boiled.', phonetic: '/ˈkɛtəl/', hebrewTranslation: 'קומקום', imageUrl: '/images/kettle.webp' },
  { id: 'vase', word: 'vase', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A container for holding flowers', exampleSentence: 'She put the flowers in a blue vase.', phonetic: '/veɪs/', hebrewTranslation: 'אגרטל', imageUrl: '/images/vase.webp' },
  { id: 'lock', word: 'lock', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A metal object that keeps a door closed and needs a key', exampleSentence: 'Dad opened the lock with his key.', phonetic: '/lɒk/', hebrewTranslation: 'מנעול', imageUrl: '/images/lock.webp' },
  { id: 'quilt', word: 'quilt', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A warm bed cover made from pieces of cloth sewn together', exampleSentence: 'Grandma made a colorful quilt for my bed.', phonetic: '/kwɪlt/', hebrewTranslation: 'שמיכת טלאים', imageUrl: '/images/quilt.webp' },
  { id: 'hammer', word: 'hammer', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A tool used for hitting nails into wood', exampleSentence: 'He used a hammer to fix the shelf.', phonetic: '/ˈhæmər/', hebrewTranslation: 'פטיש', imageUrl: '/images/hammer.webp' },
  { id: 'lighthouse', word: 'lighthouse', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A tall tower with a bright light that guides ships', exampleSentence: 'The lighthouse shone over the dark sea.', phonetic: '/ˈlaɪthaʊs/', hebrewTranslation: 'מגדלור', imageUrl: '/images/lighthouse.webp' },
  { id: 'windmill', word: 'windmill', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A building with big blades that turn in the wind', exampleSentence: 'The old windmill turned slowly in the breeze.', phonetic: '/ˈwɪndmɪl/', hebrewTranslation: 'טחנת רוח', imageUrl: '/images/windmill.webp' },
  // Transport
  { id: 'jet', word: 'jet', level: 'beginner', partOfSpeech: 'noun', category: 'transport', definition: 'A very fast airplane', exampleSentence: 'The jet flew high above the clouds.', phonetic: '/dʒɛt/', hebrewTranslation: 'מטוס סילון', imageUrl: '/images/jet.webp' },
  { id: 'anchor', word: 'anchor', level: 'intermediate', partOfSpeech: 'noun', category: 'transport', definition: 'A heavy metal hook that keeps a boat from moving', exampleSentence: 'The sailor dropped the anchor into the sea.', phonetic: '/ˈæŋkər/', hebrewTranslation: 'עוגן', imageUrl: '/images/anchor.webp' },
  { id: 'wheel', word: 'wheel', level: 'beginner', partOfSpeech: 'noun', category: 'transport', definition: 'A round part that turns and helps things move', exampleSentence: 'The bike has a big front wheel.', phonetic: '/wiːl/', hebrewTranslation: 'גלגל', imageUrl: '/images/wheel.webp' },
  // School
  { id: 'violin', word: 'violin', level: 'intermediate', partOfSpeech: 'noun', category: 'school', definition: 'A musical instrument with strings that you play with a bow', exampleSentence: 'She practices the violin every day.', phonetic: '/ˌvaɪəˈlɪn/', hebrewTranslation: 'כינור', imageUrl: '/images/violin.webp' },
  { id: 'xylophone', word: 'xylophone', level: 'advanced', partOfSpeech: 'noun', category: 'school', definition: 'A musical instrument with bars you hit with small sticks', exampleSentence: 'He played a happy song on the xylophone.', phonetic: '/ˈzaɪləfoʊn/', hebrewTranslation: 'קסילופון', imageUrl: '/images/xylophone.webp' },
  { id: 'newspaper', word: 'newspaper', level: 'intermediate', partOfSpeech: 'noun', category: 'school', definition: 'Printed pages that tell people the news', exampleSentence: 'Grandpa reads the newspaper every morning.', phonetic: '/ˈnuːzpeɪpər/', hebrewTranslation: 'עיתון', imageUrl: '/images/newspaper.webp' },
  // Everyday
  { id: 'king', word: 'king', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A man who rules a country and wears a crown', exampleSentence: 'The king sat on his golden throne.', phonetic: '/kɪŋ/', hebrewTranslation: 'מלך', imageUrl: '/images/king.webp' },
  { id: 'queen', word: 'queen', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A woman who rules a country and wears a crown', exampleSentence: 'The queen waved from the palace.', phonetic: '/kwiːn/', hebrewTranslation: 'מלכה', imageUrl: '/images/queen.webp' },
  { id: 'astronaut', word: 'astronaut', level: 'advanced', partOfSpeech: 'noun', category: 'everyday', definition: 'A person who travels into space', exampleSentence: 'The astronaut floated inside the spaceship.', phonetic: '/ˈæstrənɔːt/', hebrewTranslation: 'אסטרונאוט', imageUrl: '/images/astronaut.webp' },
  { id: 'x-ray', word: 'x-ray', level: 'advanced', partOfSpeech: 'noun', category: 'everyday', definition: 'A special picture that shows the bones inside your body', exampleSentence: 'The doctor looked at the x-ray of my arm.', phonetic: '/ˈɛksreɪ/', hebrewTranslation: 'צילום רנטגן', imageUrl: '/images/x-ray.webp' },
  { id: 'heart', word: 'heart', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'The part of your body that pumps blood, or a shape that means love', exampleSentence: 'She drew a red heart on the card.', phonetic: '/hɑːrt/', hebrewTranslation: 'לב', imageUrl: '/images/heart.webp' },
  // Clothing
  { id: 'uniform', word: 'uniform', level: 'intermediate', partOfSpeech: 'noun', category: 'clothing', definition: 'Special clothes that show you belong to a school or team', exampleSentence: 'He wore his school uniform with pride.', phonetic: '/ˈjuːnɪfɔːrm/', hebrewTranslation: 'מדים', imageUrl: '/images/uniform.webp' },
  { id: 'ring', word: 'ring', level: 'beginner', partOfSpeech: 'noun', category: 'clothing', definition: 'A round piece of jewelry you wear on your finger', exampleSentence: 'Mom wears a gold ring.', phonetic: '/rɪŋ/', hebrewTranslation: 'טבעת', imageUrl: '/images/ring.webp' },
  // Toys
  ...
  // === USER-REQUESTED B-WORDS (letter-B school list) 2026-09-20 ===
  { id: 'bag', word: 'bag', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A soft container for carrying things', exampleSentence: 'She put the apples in a bag.', phonetic: '/bæɡ/', hebrewTranslation: 'שקית', imageUrl: '/images/bag.webp' },
  { id: 'box', word: 'box', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A container with straight sides, often made of cardboard', exampleSentence: 'The toys are in the big box.', phonetic: '/bɒks/', hebrewTranslation: 'קופסה', imageUrl: '/images/box.webp' },
  { id: 'boy', word: 'boy', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A male child', exampleSentence: 'The boy kicked the ball.', phonetic: '/bɔɪ/', hebrewTranslation: 'ילד', imageUrl: '/images/boy.webp' },
  { id: 'bell', word: 'bell', level: 'beginner', partOfSpeech: 'noun', category: 'school', definition: 'A metal object that rings when you shake or hit it', exampleSentence: 'The school bell rang at nine.', phonetic: '/bɛl/', hebrewTranslation: 'פעמון', imageUrl: '/images/bell.webp' },
  { id: 'bone', word: 'bone', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A hard white part inside the body; dogs love to chew them', exampleSentence: 'The dog buried a bone in the yard.', phonetic: '/boʊn/', hebrewTranslation: 'עצם', imageUrl: '/images/bone.webp' },
  { id: 'boot', word: 'boot', level: 'beginner', partOfSpeech: 'noun', category: 'clothing', definition: 'A tall shoe that covers part of your leg', exampleSentence: 'She wore a rubber boot in the rain.', phonetic: '/buːt/', hebrewTranslation: 'מגף', imageUrl: '/images/boot.webp' },
  { id: 'brush', word: 'brush', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A tool with bristles for fixing your hair', exampleSentence: 'She fixed her hair with a brush.', phonetic: '/brʌʃ/', hebrewTranslation: 'מברשת', imageUrl: '/images/brush.webp' },
  { id: 'baby', word: 'baby', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A very young child', exampleSentence: 'The baby smiled at everyone.', phonetic: '/ˈbeɪbi/', hebrewTranslation: 'תינוק', imageUrl: '/images/baby.webp' },
  { id: 'button', word: 'button', level: 'beginner', partOfSpeech: 'noun', category: 'clothing', definition: 'A small round thing that closes your shirt', exampleSentence: 'One button fell off his shirt.', phonetic: '/ˈbʌtən/', hebrewTranslation: 'כפתור', imageUrl: '/images/button.webp' },
  ...
  // === USER-REQUESTED E+F WORDS (letter school lists) 2026-09-20 ===
  { id: 'earth', word: 'earth', level: 'intermediate', partOfSpeech: 'noun', category: 'nature', definition: 'The planet we all live on', exampleSentence: 'The earth looks blue from space.', phonetic: '/ɜːrθ/', hebrewTranslation: 'כדור הארץ', imageUrl: '/images/earth.webp' },
  { id: 'elevator', word: 'elevator', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A machine that carries people up and down a building', exampleSentence: 'We took the elevator to the fifth floor.', phonetic: '/ˈɛlɪveɪtər/', hebrewTranslation: 'מעלית', imageUrl: '/images/elevator.webp' },
  { id: 'fan', word: 'fan', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A machine with blades that blows cool air', exampleSentence: 'The fan cooled the hot room.', phonetic: '/fæn/', hebrewTranslation: 'מאוורר', imageUrl: '/images/fan.webp' },
  { id: 'fig', word: 'fig', level: 'intermediate', partOfSpeech: 'noun', category: 'food', definition: 'A soft sweet fruit that grows on a tree', exampleSentence: 'She picked a ripe fig from the tree.', phonetic: '/fɪɡ/', hebrewTranslation: 'תאנה', imageUrl: '/images/fig.webp' },
  { id: 'fire', word: 'fire', level: 'beginner', partOfSpeech: 'noun', category: 'nature', definition: 'Hot bright flames that burn', exampleSentence: 'We sat around the fire and sang.', phonetic: '/ˈfaɪər/', hebrewTranslation: 'אש', imageUrl: '/images/fire.webp' },
  { id: 'flag', word: 'flag', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A piece of cloth with colors that waves on a pole', exampleSentence: 'The flag waved in the wind.', phonetic: '/flæɡ/', hebrewTranslation: 'דגל', imageUrl: '/images/flag.webp' },
  { id: 'farmer', word: 'farmer', level: 'intermediate', partOfSpeech: 'noun', category: 'everyday', definition: 'A person who grows food and takes care of farm animals', exampleSentence: 'The farmer fed the chickens.', phonetic: '/ˈfɑːrmər/', hebrewTranslation: 'חקלאי', imageUrl: '/images/farmer.webp' },
  { id: 'fairy', word: 'fairy', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A tiny magical person with wings from stories', exampleSentence: 'The fairy waved her magic wand.', phonetic: '/ˈfɛri/', hebrewTranslation: 'פיה', imageUrl: '/images/fairy.webp' },
  { id: 'family', word: 'family', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'The people who live with you and love you', exampleSentence: 'My family eats dinner together.', phonetic: '/ˈfæməli/', hebrewTranslation: 'משפחה', imageUrl: '/images/family.webp' },
  { id: 'fountain', word: 'fountain', level: 'intermediate', partOfSpeech: 'noun', category: 'everyday', definition: 'A place where water shoots up into the air', exampleSentence: 'Coins sparkled in the fountain.', phonetic: '/ˈfaʊntən/', hebrewTranslation: 'מזרקה', imageUrl: '/images/fountain.webp' },
  { id: 'fridge', word: 'fridge', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'A cold cupboard that keeps food fresh', exampleSentence: 'The milk is in the fridge.', phonetic: '/frɪdʒ/', hebrewTranslation: 'מקרר', imageUrl: '/images/fridge.webp' },
  { id: 'fries', word: 'fries', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'Thin sticks of potato fried until crispy', exampleSentence: 'He shared his fries with his sister.', phonetic: '/fraɪz/', hebrewTranslation: "צ'יפס", imageUrl: '/images/fries.webp' },

  // === USER-REQUESTED G+H WORDS (letter school lists) 2026-09-20 ===
  { id: 'gate', word: 'gate', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A door in a fence or wall outside', exampleSentence: 'Close the gate so the dog stays in.', phonetic: '/ɡeɪt/', hebrewTranslation: 'שער', imageUrl: '/images/gate.webp' },
  { id: 'gift', word: 'gift', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A present you give someone wrapped in nice paper', exampleSentence: 'She got a gift for her birthday.', phonetic: '/ɡɪft/', hebrewTranslation: 'מתנה', imageUrl: '/images/gift.webp' },
  { id: 'girl', word: 'girl', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A female child', exampleSentence: 'The girl drew a beautiful picture.', phonetic: '/ɡɜːrl/', hebrewTranslation: 'ילדה', imageUrl: '/images/girl.webp' },
  { id: 'glue', word: 'glue', level: 'beginner', partOfSpeech: 'noun', category: 'school', definition: 'Sticky stuff that makes things stay together', exampleSentence: 'Use glue to stick the paper shapes.', phonetic: '/ɡluː/', hebrewTranslation: 'דבק', imageUrl: '/images/glue.webp' },
  { id: 'goose', word: 'goose', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A big white bird with a long neck', exampleSentence: 'The goose honked loudly at us.', phonetic: '/ɡuːs/', hebrewTranslation: 'אווז', imageUrl: '/images/goose.webp' },
  { id: 'ghost', word: 'ghost', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A white floating spirit from spooky stories', exampleSentence: 'The friendly ghost said boo!', phonetic: '/ɡoʊst/', hebrewTranslation: 'רוח רפאים', imageUrl: '/images/ghost.webp' },
  { id: 'glasses', word: 'glasses', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'Round pieces of glass you wear to see better', exampleSentence: 'Grandpa reads with his glasses on.', phonetic: '/ˈɡlæsɪz/', hebrewTranslation: 'משקפיים', imageUrl: '/images/glasses.webp' },
  { id: 'gorilla', word: 'gorilla', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A very big strong ape with black fur', exampleSentence: 'The gorilla ate leaves quietly.', phonetic: '/ɡəˈrɪlə/', hebrewTranslation: 'גורילה', imageUrl: '/images/gorilla.webp' },
  { id: 'grandma', word: 'grandma', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'Your mother\'s or father\'s mother', exampleSentence: 'Grandma bakes the best cookies.', phonetic: '/ˈɡrænmɑː/', hebrewTranslation: 'סבתא', imageUrl: '/images/grandma.webp' },
  { id: 'grandpa', word: 'grandpa', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'Your mother\'s or father\'s father', exampleSentence: 'Grandpa tells wonderful stories.', phonetic: '/ˈɡrænpɑː/', hebrewTranslation: 'סבא', imageUrl: '/images/grandpa.webp' },
  { id: 'hose', word: 'hose', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A long bendy tube that water flows through', exampleSentence: 'He watered the garden with a hose.', phonetic: '/hoʊz/', hebrewTranslation: 'צינור השקיה', imageUrl: '/images/hose.webp' },
  { id: 'hammock', word: 'hammock', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A hanging bed made of cloth tied between two trees', exampleSentence: 'Dad napped in the hammock.', phonetic: '/ˈhæmək/', hebrewTranslation: 'ערסל', imageUrl: '/images/hammock.webp' },
  ...
  // === USER-REQUESTED K+L WORDS (letter school lists) 2026-09-21 ===
  { id: 'kitchen', word: 'kitchen', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'The room where food is cooked', exampleSentence: 'Mom is making soup in the kitchen.', phonetic: '/ˈkɪtʃɪn/', hebrewTranslation: 'מטבח', imageUrl: '/images/kitchen.webp' },
  { id: 'knight', word: 'knight', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A brave fighter in metal armor from castle times', exampleSentence: 'The knight rode a white horse.', phonetic: '/naɪt/', hebrewTranslation: 'אביר', imageUrl: '/images/knight.webp' },
  { id: 'ketchup', word: 'ketchup', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A red sauce made from tomatoes', exampleSentence: 'He put ketchup on his fries.', phonetic: '/ˈkɛtʃəp/', hebrewTranslation: 'קטשופ', imageUrl: '/images/ketchup.webp' },
  { id: 'kiwi', word: 'kiwi', level: 'intermediate', partOfSpeech: 'noun', category: 'food', definition: 'A small fruit that is brown outside and green inside', exampleSentence: 'She cut the kiwi in half.', phonetic: '/ˈkiːwiː/', hebrewTranslation: 'קיווי', imageUrl: '/images/kiwi.webp' },
  { id: 'lollipop', word: 'lollipop', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A sweet candy on a stick', exampleSentence: 'The lollipop had rainbow swirls.', phonetic: '/ˈlɒlipɒp/', hebrewTranslation: 'סוכרייה על מקל', imageUrl: '/images/lollipop.webp' },
  { id: 'lizard', word: 'lizard', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A small animal with dry skin and a long tail', exampleSentence: 'A lizard ran up the warm wall.', phonetic: '/ˈlɪzərd/', hebrewTranslation: 'לטאה', imageUrl: '/images/lizard.webp' },
  { id: 'llama', word: 'llama', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A tall woolly animal with a long neck from the mountains', exampleSentence: 'The llama has soft brown wool.', phonetic: '/ˈlɑːmə/', hebrewTranslation: 'לאמה', imageUrl: '/images/llama.webp' },
  { id: 'ladybug', word: 'ladybug', level: 'beginner', partOfSpeech: 'noun', category: 'animals', definition: 'A small round red beetle with black dots', exampleSentence: 'A ladybug landed on her hand.', phonetic: '/ˈleɪdibʌɡ/', hebrewTranslation: 'פרת משה רבנו', imageUrl: '/images/ladybug.webp' },

  // === USER-REQUESTED M+N WORDS (letter school lists) 2026-09-21 ===
  { id: 'map', word: 'map', level: 'beginner', partOfSpeech: 'noun', category: 'school', definition: 'A drawing that shows where places are', exampleSentence: 'We found Israel on the map.', phonetic: '/mæp/', hebrewTranslation: 'מפה', imageUrl: '/images/map.webp' },
  { id: 'mask', word: 'mask', level: 'beginner', partOfSpeech: 'noun', category: 'toys', definition: 'Something you wear over your face to look different', exampleSentence: 'He wore a lion mask on Purim.', phonetic: '/mæsk/', hebrewTranslation: 'מסכה', imageUrl: '/images/mask.webp' },
  { id: 'mom', word: 'mom', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'Your mother', exampleSentence: 'Mom gave me a big hug.', phonetic: '/mɒm/', hebrewTranslation: 'אמא', imageUrl: '/images/mom.webp' },
  { id: 'marble', word: 'marble', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A small shiny glass ball you play with', exampleSentence: 'He won three marbles in the game.', phonetic: '/ˈmɑːrbəl/', hebrewTranslation: 'גולה', imageUrl: '/images/marble.webp' },
  { id: 'mango', word: 'mango', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A sweet orange tropical fruit', exampleSentence: 'The mango juice ran down his chin.', phonetic: '/ˈmæŋɡoʊ/', hebrewTranslation: 'מנגו', imageUrl: '/images/mango.webp' },
  { id: 'mermaid', word: 'mermaid', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A storybook girl with a fish tail instead of legs', exampleSentence: 'The mermaid swam deep under the sea.', phonetic: '/ˈmɜːrmeɪd/', hebrewTranslation: 'בת ים', imageUrl: '/images/mermaid.webp' },
  { id: 'microphone', word: 'microphone', level: 'intermediate', partOfSpeech: 'noun', category: 'everyday', definition: 'A device that makes your voice louder', exampleSentence: 'She sang into the microphone.', phonetic: '/ˈmaɪkrəfoʊn/', hebrewTranslation: 'מיקרופון', imageUrl: '/images/microphone.webp' },
  { id: 'nail', word: 'nail', level: 'intermediate', partOfSpeech: 'noun', category: 'home', definition: 'A thin metal pin you hammer into wood', exampleSentence: 'He hit the nail with the hammer.', phonetic: '/neɪl/', hebrewTranslation: 'מסמר', imageUrl: '/images/nail.webp' },
  { id: 'nose', word: 'nose', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'The part of your face you smell with', exampleSentence: 'The clown had a red nose.', phonetic: '/noʊz/', hebrewTranslation: 'אף', imageUrl: '/images/nose.webp' },
  { id: 'nurse', word: 'nurse', level: 'beginner', partOfSpeech: 'noun', category: 'everyday', definition: 'A person who takes care of sick people', exampleSentence: 'The nurse gave me a bandage.', phonetic: '/nɜːrs/', hebrewTranslation: 'אחות', imageUrl: '/images/nurse.webp' },
  { id: 'necklace', word: 'necklace', level: 'intermediate', partOfSpeech: 'noun', category: 'clothing', definition: 'A pretty chain you wear around your neck', exampleSentence: 'Grandma wore a pearl necklace.', phonetic: '/ˈnɛkləs/', hebrewTranslation: 'שרשרת', imageUrl: '/images/necklace.webp' },
  { id: 'ninja', word: 'ninja', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A quick quiet fighter dressed in black from stories', exampleSentence: 'The ninja jumped over the wall.', phonetic: '/ˈnɪndʒə/', hebrewTranslation: "נינג'ה", imageUrl: '/images/ninja.webp' },

  // === FINAL ALPHABET BATCH O-W (2026-09-21) — completes school coverage A-Z ===
  { id: 'oven', word: 'oven', level: 'beginner', partOfSpeech: 'noun', category: 'home', definition: 'The hot box in the kitchen where food is baked', exampleSentence: 'The cake is baking in the oven.', phonetic: '/ˈʌvən/', hebrewTranslation: 'תנור', imageUrl: '/images/oven.webp' },
  { id: 'olive', word: 'olive', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A small green or black fruit that grows on a tree', exampleSentence: 'She put olives on the pizza.', phonetic: '/ˈɒlɪv/', hebrewTranslation: 'זית', imageUrl: '/images/olive.webp' },
  { id: 'ocean', word: 'ocean', level: 'intermediate', partOfSpeech: 'noun', category: 'nature', definition: 'The huge deep water that covers most of the world', exampleSentence: 'Whales live deep in the ocean.', phonetic: '/ˈoʊʃən/', hebrewTranslation: 'אוקיינוס', imageUrl: '/images/ocean.webp' },
  { id: 'peacock', word: 'peacock', level: 'intermediate', partOfSpeech: 'noun', category: 'animals', definition: 'A bird that opens its tail like a giant colorful fan', exampleSentence: 'The peacock showed its beautiful tail.', phonetic: '/ˈpiːkɒk/', hebrewTranslation: 'טווס', imageUrl: '/images/peacock.webp' },
  { id: 'pirate', word: 'pirate', level: 'intermediate', partOfSpeech: 'noun', category: 'toys', definition: 'A sailor from stories who hunts for treasure', exampleSentence: 'The pirate found a treasure chest.', phonetic: '/ˈpaɪrət/', hebrewTranslation: 'שודד ים', imageUrl: '/images/pirate.webp' },
  { id: 'pumpkin', word: 'pumpkin', level: 'beginner', partOfSpeech: 'noun', category: 'food', definition: 'A big round orange vegetable', exampleSentence: 'The pumpkin soup was warm and sweet.', phonetic: '/ˈpʌmpkɪn/', hebrewTranslation: 'דלעת', imageUrl: '/images/pumpkin.webp' },
  { id: 'rooster', word: 'rooster', level: 'beginner', partOfSpeech: 'noun', category: 'animals', definition: 'A male chicken that crows in the morning', exampleSentence: 'The rooster crowed at sunrise.', phonetic: '/ˈruːstər/', hebrewTranslation: 'תרנגול', imageUrl: '/images/rooster.webp' },
