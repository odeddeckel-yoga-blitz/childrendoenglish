  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">{t('managePlayers', lang)}</h2>
      </div>
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 py-2.5 rounded-xl border border-slate-300 text-slate-600 dark:text-slate-300 text-sm font-medium
          ...
          <div ref={confirmModalRef} role="dialog" aria-modal="true" className="glass rounded-2xl p-6 max-w-sm w-full space-y-4 text-center" onClick={e => e.stopPropagation()}>
            {confirmAction.type === 'deleteAll' ? (
              <>
                ...
                <p className="text-slate-700 dark:text-slate-200 font-medium">{t('deleteAllConfirm', lang)}</p>
              </>
            ) : (
              <>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 dark:text-slate-300 font-semibold
