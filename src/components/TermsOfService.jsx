  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-xl font-bold text-slate-800">{t('termsTitle', lang)}</h2>
      </div>
      ...
      <div className="glass rounded-2xl p-5 space-y-4 text-sm text-slate-600 leading-relaxed">
        ...
        <section className="space-y-2">
          <h3 className="font-bold text-slate-800">{t('termsAcceptTitle', lang)}</h3>
          <p>{t('termsAcceptDesc', lang)}</p>
        </section>

        <section className="space-y-2">
          <h3 className="font-bold text-slate-800">{t('termsUseTitle', lang)}</h3>
          <p>{t('termsUseDesc', lang)}</p>
        </section>

        <section className="space-y-2">
          <h3 className="font-bold text-slate-800">{t('termsContentTitle', lang)}</h3>
          <p>{t('termsContentDesc', lang)}</p>
        </section>

        <section className="space-y-2">
          <h3 className="font-bold text-slate-800">{t('termsDisclaimerTitle', lang)}</h3>
          <p>{t('termsDisclaimerDesc', lang)}</p>
        </section>

        <section className="space-y-2">
          <h3 className="font-bold text-slate-800">{t('termsChangesTitle', lang)}</h3>
          <p>{t('termsChangesDesc', lang)}</p>
        </section>

        <section className="space-y-2">
          <h3 className="font-bold text-slate-800">{t('termsContactTitle', lang)}</h3>
