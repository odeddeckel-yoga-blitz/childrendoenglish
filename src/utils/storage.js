...
const getDefaultStats = () => ({
  ...
  arcade: {                 // kidsdomath-crossover arcade layer
    ...
    lightningRounds: 0,     // total lightning rounds played
    categoriesTried: [],    // distinct word categories seen in completed quizzes
    modesPlayed: [],        // distinct quiz modes completed
  },
});
